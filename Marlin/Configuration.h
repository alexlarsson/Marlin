...
#define STRING_CONFIG_H_AUTHOR "Alexander Larsson" // Who made the changes.
...
#define MACHINE_UUID "cd3e1335-9ba6-41fb-b4ca-dd55fb280f0a"
...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 145.4 // mm
  ...
  #define DELTA_ENDSTOP_ADJ { -0.23, -0.27, 0 } // get these from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.8, 0.6, 0 } // get these from auto calibrate

  // delta radius and diaginal rod adjustments measured in mm
  //#define DELTA_RADIUS_TRIM_TOWER {0, 0, 0}
  #define DELTA_DIAGONAL_ROD_TRIM_TOWER {0, 0, 1.0}
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 0.5     // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER +15.8   // Y offset: -front +behind [the nozzle]
